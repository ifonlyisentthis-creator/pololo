...
class _ImmediateAdService extends AdService {
  @override
...
void main() {
  testWidgets(
    'ticker resumes after ad closes before death screen route is shown',
    (tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            ...
            adServiceProvider.overrideWithValue(_ImmediateAdService()),
          ],
      ...
      engine.deathFlashTimer = 1.0;
      engine.state = GameState.dead;

      await tester.pump(const Duration(milliseconds: 20));
      final timerAfterAdClosed = engine.deathFlashTimer;

      await tester.pump(const Duration(milliseconds: 200));

      expect(find.byType(GameScreen), findsOneWidget);
      expect(engine.deathFlashTimer, lessThan(timerAfterAdClosed));
